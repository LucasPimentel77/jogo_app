...
class Button:
    ...
    def set_multiline(self, symbol, label):
        self.text_obj.set_multiline(symbol, label)

    def update_hover(self, mouse_pos, bg_color=CINZA_CLARO, text_color=PRETO):
        if self.rect.collidepoint(mouse_pos):
            ...
            self.text_obj.color = self.original_text_color
